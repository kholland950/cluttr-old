...
public final class friends_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    boolean isMe = userId == session.getAttribute("user");
      ...
      out.write("<html>\n");
      out.write("<head>\n");
      out.write("    <title>cluttr | friends</title>\n");
      out.write("    ");
 ...
 if (isMe) { 
      ...
      out.print(UserUtil.getUsername(userId));
      out.write("'s ");
 } 
      out.write(" friends</h2>\n");
      ...
      out.write("        ");
        ...
        if (friends.size() == 0) { 
      out.write("\n");
      out.write("            <h5>you have no friends yet.</h5>\n");
